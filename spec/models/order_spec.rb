...
RSpec.describe Order do
  ...
  describe 'instance methods' do
    before :each do
      ...
      @frog = @brian.items.create!(name: 'Frog', description: "I'm a Frog!", price: 50, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: true, inventory: 20 )
      ...
      @discount_1 = @brian.discounts.create!(percent_off: 10, items_number: 10)
      ...
      # @order_item_4 = @order_3.order_items.create!(item: @frog, price: @frog.price, quantity: 12, fulfilled: false)
    end
